...
public class RendererJogl implements GLEventListener
{
  ...
  //extractFrustum();
  //System.out.println("laving setPerspective3D()...");
  }
  ...
  private void drawTestObject(GL gl, GLU glu, GLUT glut)
  {
    setPerspective3D();
  ...
  public void display(GLAutoDrawable drawable)
  {
    ...
    gl = drawable.getGL();    //Check to see if we need to load in a new font family
    //if (FontHandler.fontsReady == true)
    {
