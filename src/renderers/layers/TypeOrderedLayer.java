 ...
 * That is, if you have a class in a different package but with the same name 
 * --For example, customPackage.GeomImage and geometry.GeomImage-- they both need to be described by
 * their simple (packages-less) name-- eg, "GeomImage"-- and thus will be treated as the same 
