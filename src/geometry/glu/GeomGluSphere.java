 ...
 * @author angus
 */
public class GeomGluSphere extends Geom
{
  ...
  public GeomGluSphere(Point3f centerPt, float innerRadius, float outerRadius, float startAngle, float endAngle, int resolution)
  {
    super(centerPt);
