...
public class Colorf
{
  ...
  /**
   * Returns a representation of this color as a float array.
   * Can be used to simplify a call to glColor4fv. For example:
  ...
  /**
   * Determines the appropriate values to transform color1 into color2.
  ...
  {
    return "color = " + Utils.decimalFormat(this.r) + "/" + Utils.decimalFormat(this.a) + "/" + Utils.decimalFormat(this.b) + "/" + Utils.decimalFormat(this.a);
  }
}
