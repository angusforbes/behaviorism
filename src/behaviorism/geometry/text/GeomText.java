...
public class GeomText extends GeomRect
{
  ...
  private void initialize(TextBuilder builder)
  {
    ...
    else
    {
      ...
      {
	this.textRenderers = FontHandler.getInstance().getDefaultTextRenderers();
      }
    }
  }
...
//    }
  ...
  {
    TextRenderer fi = textRenderers.get(textRenderers.size() - 1); 
...
//    }
  ...
  {
    this.textRenderer = FontHandler.getInstance().getOrCreateTextRenderer(fontString, fontStyle, fontSize);
  ...
  {
    this.textRenderers = FontHandler.getInstance().getOrCreateTextRenderers(fontString, fontStyle);
