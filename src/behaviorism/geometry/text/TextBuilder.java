 ...
 public class TextBuilder
  {
    ...
    {
      //this.textRenderers = FontHandler.getInstance().getTextRenderers(font, fontStyle);
      this.textRenderers = FontHandler.getInstance().getOrCreateTextRenderers(font, fontStyle);
      return this;
    }
    ...
    {
      //this.textRenderers = FontHandler.getInstance().getTextRenderers(font, Font.PLAIN);
      this.textRenderers = FontHandler.getInstance().getOrCreateTextRenderers(font, Font.PLAIN);
      return this;
    }
    ...
    public TextBuilder font(String fontName, int fontStyle, float fontSize)
    {
      ...
      this.nonDynamicTextRenderer = FontHandler.getInstance().getOrCreateTextRenderer(fontName, fontStyle, fontSize);
