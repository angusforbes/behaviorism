 ...
 * @author angus
 */
public class CamBasic2 extends Cam
{
   ...
   */
  public CamBasic2(Point3f p3f)
  {
    initialize(p3f);
  }

  public CamBasic2(float x, float y, float z)
  {
  ...
  {
    //this.modelview = MatrixUtils.getIdentity();
  ...
  public void view()
  {
    System.out.println("in camBasic2 : perspective()");
